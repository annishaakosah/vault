...
export class DetailsPage {
  ...
  ionViewWillEnter() {
    ...
    this.search.getByID(this.id).then(
      data => {
        this.show = data;
      },
      err => {
  ...
  public addToWatchList = () =>
    this.imdbService.addToWatchList(this.show.id, this.show.poster_path);

  public addToAlreadyWatchedList = () =>
    this.imdbService.addToAlreadyWatched(this.show.id, this.show.poster_path);
      ...
      buttons: [
        {
          ...
          handler: () => {
            this.socialSharing.shareViaFacebook(
              'Check out "' + show.name + '" I just discovered using #vault',
